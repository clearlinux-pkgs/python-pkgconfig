...
%prep
%setup -q -n pkgconfig-1.5.2
cd %{_builddir}/pkgconfig-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613749725
...
cp %{_builddir}/pkgconfig-1.5.2/LICENSE %{buildroot}/usr/share/package-licenses/python-pkgconfig/6f33807d1075cf857dc91cf3cf8607894ebd11e0
