...
Version  : 1.5.3
Release  : 43
URL      : https://files.pythonhosted.org/packages/9a/8a/600d7e96368a86c713002630be1dd069b9905a7a7854a59641acc2e753cd/pkgconfig-1.5.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/9a/8a/600d7e96368a86c713002630be1dd069b9905a7a7854a59641acc2e753cd/pkgconfig-1.5.3.tar.gz
...
%prep
%setup -q -n pkgconfig-1.5.3
cd %{_builddir}/pkgconfig-1.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622737148
...
cp %{_builddir}/pkgconfig-1.5.3/LICENSE %{buildroot}/usr/share/package-licenses/python-pkgconfig/6f33807d1075cf857dc91cf3cf8607894ebd11e0
